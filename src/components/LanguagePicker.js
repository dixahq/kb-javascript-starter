...
function LanguagePicker({ selectedLanguageId, setCurrentLanguageId, supportedLanguages }) {
  ...
  return (
    <div className="language-picker">
      <div className="language-picker-input" onClick={() => setOpen(!open)}>
        <img className="language-picker-image" src={selectedLanguage.iconPath} />
      ...
      {open && (
        <>
          <div className="language-picker-overlay" onClick={() => setOpen(false)} />
          <ul className="language-picker-list">
            {supportedLanguages.map(({ iconPath, id, label }, index) => {
              return (
                <li className="language-picker-item" key={index} onClick={() => setCurrentLanguageId(id)}>
